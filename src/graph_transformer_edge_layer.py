"""
@ Description: Gated Graph Transform
Modified by https://github.com/graphdeeplearning/graphtransformer/blob/main/layers/graph_transformer_edge_layer.py
"""
import torch
...
def sigmoid_gage(attention_score, gate):
    def func(edges):
